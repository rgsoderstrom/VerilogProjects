...
# set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { PhaseA1 }]; #IO_0_15            Sch=ck_a[0]
# set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { PhaseB1 }]; #IO_L4P_T0_15       Sch=ck_a[1]
# set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { PhaseA2 }]; #IO_L4N_T0_15       Sch=ck_a[2]
# set_property -dict { PACKAGE_PIN C13   IOSTANDARD LVCMOS33 } [get_ports { PhaseB2 }]; #IO_L6P_T0_15       Sch=ck_a[3]
