...
#
# MandE_Arty.xdc - constraints to run MotorsAndEncoders on Arty S7-50
#
...
#set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { PhaseA1   }]; #IO_L22P_T3_A17_15   Sch=ck_io10_ss
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { PhaseB1 }]; #IO_L22N_T3_A16_15   Sch=ck_io11_mosi
#set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { PhaseA2 }]; #IO_L23P_T3_FOE_B_15 Sch=ck_io12_miso
#set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { PhaseB2  }]; #IO_L14P_T2_SRCC_15  Sch=ck_io13_sck
...
set_property -dict { PACKAGE_PIN P13   IOSTANDARD LVCMOS33 } [get_ports { PhaseB2 }]; #IO_L19P_T3_A10_D26_14        Sch=jc8/ck_io[36]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { PhaseA2 }]; #IO_L16P_T2_CSI_B_14          Sch=jc7/ck_io[37]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { PhaseB1 }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=jc4/ck_io[38]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { PhaseA1 }]; #IO_L15P_T2_DQS_RDWR_B_14     Sch=jc3/ck_io[39]
...
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { SampleEnc }]; #IO_L4N_T0_15       Sch=ck_a[2]
...
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { LoadPWM }];   #IO_L11P_T1_SRCC_15 Sch=ck_a[5]
...
set_property -dict { PACKAGE_PIN B14   IOSTANDARD LVCMOS33 } [get_ports { PWM1Out  }]; #IO_L2P_T0_AD8P_15     Sch=ad_p[8]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { PWM2Out  }]; #IO_L2N_T0_AD8N_15     Sch=ad_n[8]
set_property -dict { PACKAGE_PIN D16   IOSTANDARD LVCMOS33 } [get_ports { triggerInterrupt }]; #IO_L9P_T1_DQS_AD3P_15 Sch=ad_p[3] # was A8 
