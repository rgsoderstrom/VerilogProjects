...
set_property -dict {PACKAGE_PIN C2 IOSTANDARD LVCMOS33} [get_ports {sw5}]
set_property -dict {PACKAGE_PIN B2 IOSTANDARD LVCMOS33} [get_ports {sw6}]
set_property -dict {PACKAGE_PIN B1 IOSTANDARD LVCMOS33} [get_ports {sw7}]

#set_property -dict {PACKAGE_PIN A2  IOSTANDARD LVCMOS33} [get_ports {ana0}]
#set_property -dict {PACKAGE_PIN H2  IOSTANDARD LVCMOS33} [get_ports {ana1}]
#set_property -dict {PACKAGE_PIN B10 IOSTANDARD LVCMOS33} [get_ports {ana2}]
#set_property -dict {PACKAGE_PIN C8  IOSTANDARD LVCMOS33} [get_ports {ana3}]

#set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS33} [get_ports {dac_clock}]
#set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS33} [get_ports {io[12]}]
#set_property -dict {PACKAGE_PIN C9  IOSTANDARD LVCMOS33} [get_ports {segA}]

# was io[20]
set_property -dict {PACKAGE_PIN K5 IOSTANDARD LVCMOS33} [get_ports {dac_clock}]

# was io[21]
set_property -dict {PACKAGE_PIN A3 IOSTANDARD LVCMOS33} [get_ports {dac_busy}]
...
#set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {segB}]
#set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports {segC}]
#set_property -dict {PACKAGE_PIN P11 IOSTANDARD LVCMOS33} [get_ports {segD}]
#set_property -dict {PACKAGE_PIN T2  IOSTANDARD LVCMOS33} [get_ports {segE}]
#set_property -dict {PACKAGE_PIN T4  IOSTANDARD LVCMOS33} [get_ports {segF}]
#set_property -dict {PACKAGE_PIN T5  IOSTANDARD LVCMOS33} [get_ports {segG}]
#set_property -dict {PACKAGE_PIN T7  IOSTANDARD LVCMOS33} [get_ports {segDot}]
