...
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports {io[0]}]
...
set_property -dict {PACKAGE_PIN C2 IOSTANDARD LVCMOS33} [get_ports {io[5]}]
...
set_property -dict {PACKAGE_PIN A2 IOSTANDARD LVCMOS33} [get_ports {io[8]}]
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports {io[9]}]
