...
/*
    FIFO_Testbench - test empty/full logic
*/

`timescale 1ns / 1ps

module FIFO1_Testbench;

    localparam DataWidth = 8; 

    reg  [DataWidth-1:0] testPatterns [0:15];
...
//                    U1.fifo.ReadAddr, U1.fifo.WriteAddr, U1.fifo.NumberStored, U1.fifo.Full, U1.fifo.Empty, ReceivedWord);
    ...
    begin
        ...
        #100 readCycle = 1; // keep reading when empty
        #10  readCycle = 0;
